...
#include "SettingsItemVisualsMotionBlur.generated.h"

/**
 * @brief An implementation for the visuals motion blur settings item
 */
UCLASS()
class USettingsItemVisualsMotionBlur : public USettingsItem
{
	GENERATED_BODY()
