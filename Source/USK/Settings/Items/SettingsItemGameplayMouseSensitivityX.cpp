...
#include "SettingsItemGameplayMouseSensitivityX.h"
 ...
 */
void USettingsItemGameplayMouseSensitivityX::ConfigureMenuItem(const USettingsConfig* Config,
	const USettingsData* Settings, UMenuItem* MenuItem)
{
	MenuItem->ValueMapping.Empty();	
	MenuItem->MinValue = Config->GameplayMouseSensitivityXMin;
	MenuItem->MaxValue = Config->GameplayMouseSensitivityXMax;
	MenuItem->DefaultValue = Settings->GameplayMouseSensitivityXModified
		? Settings->GameplayMouseSensitivityX
		: Config->GameplayMouseSensitivityXDefault;
	MenuItem->SetTitle(Config->GameplayMouseSensitivityXText);
}
 ...
 */
USettingsData* USettingsItemGameplayMouseSensitivityX::SaveSettings(USettingsData* Settings, const UMenuItem* MenuItem)
{
	Settings->GameplayMouseSensitivityXModified = true;
	Settings->GameplayMouseSensitivityX = MenuItem->GetValue();
 ...
 * @param Settings The current settings data
 */
void USettingsItemGameplayMouseSensitivityX::ApplySettings(UObject* World, const USettingsConfig* Config,
