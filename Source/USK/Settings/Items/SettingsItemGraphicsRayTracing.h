...
#include "SettingsItemGraphicsRayTracing.generated.h"

/**
 * @brief An implementation for the graphics ray tracing settings item
 */
UCLASS()
class USettingsItemGraphicsRayTracing : public USettingsItem
{
	GENERATED_BODY()
