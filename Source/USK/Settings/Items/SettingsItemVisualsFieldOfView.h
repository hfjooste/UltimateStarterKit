...
#include "SettingsItemVisualsFieldOfView.generated.h"

/**
 * @brief An implementation for the visuals field of view settings item
 */
UCLASS()
class USettingsItemVisualsFieldOfView : public USettingsItem
{
	GENERATED_BODY()
