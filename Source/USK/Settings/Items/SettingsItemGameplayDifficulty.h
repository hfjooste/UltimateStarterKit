...
#include "SettingsItemGameplayDifficulty.generated.h"

/**
 * @brief An implementation for the gameplay difficulty settings item
 */
UCLASS()
class USettingsItemGameplayDifficulty : public USettingsItem
{
	GENERATED_BODY()
