...
#include "SettingsItemGameplayMouseSensitivityX.generated.h" 

/**
 * @brief An implementation for the gameplay mouse sensitivity X settings item
 */
UCLASS()
class USettingsItemGameplayMouseSensitivityX : public USettingsItem
{
	GENERATED_BODY()
