...
#include "SettingsItemGameplayMouseSensitivityY.generated.h" 

/**
 * @brief An implementation for the gameplay mouse sensitivity Y settings item
 */
UCLASS()
class USettingsItemGameplayMouseSensitivityY : public USettingsItem
{
	GENERATED_BODY()
