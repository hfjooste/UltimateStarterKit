...
#include "SettingsItemAudioAmbience.generated.h"

/**
 * @brief An implementation for the audio ambience settings item
 */
UCLASS()
class USettingsItemAudioAmbience : public USettingsItem
{
	GENERATED_BODY()
