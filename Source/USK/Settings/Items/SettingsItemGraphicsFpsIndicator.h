...
#include "SettingsItemGraphicsFpsIndicator.generated.h"

/**
 * @brief An implementation for the graphics FPS indicator settings item
 */
UCLASS()
class USettingsItemGraphicsFpsIndicator : public USettingsItem
{
	GENERATED_BODY()
