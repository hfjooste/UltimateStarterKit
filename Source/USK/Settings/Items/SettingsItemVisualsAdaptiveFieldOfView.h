...
#include "SettingsItemVisualsAdaptiveFieldOfView.generated.h"

/**
 * @brief An implementation for the visuals adaptive field of view settings item
 */
UCLASS()
class USettingsItemVisualsAdaptiveFieldOfView : public USettingsItem
{
	GENERATED_BODY()
