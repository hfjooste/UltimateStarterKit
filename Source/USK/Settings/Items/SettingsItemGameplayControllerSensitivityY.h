...
#include "SettingsItemGameplayControllerSensitivityY.generated.h" 

/**
 * @brief An implementation for the gameplay controller sensitivity Y settings item
 */
UCLASS()
class USettingsItemGameplayControllerSensitivityY : public USettingsItem
{
	GENERATED_BODY()
