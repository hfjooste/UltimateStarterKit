...
#include "SettingsItemGraphicsShadowQuality.generated.h"

/**
 * @brief An implementation for the graphics shadow quality settings item
 */
UCLASS()
class USettingsItemGraphicsShadowQuality : public USettingsItem
{
	GENERATED_BODY()
