...
#include "SettingsItemGameplayControllerSensitivityX.generated.h" 

/**
 * @brief An implementation for the gameplay controller sensitivity X settings item
 */
UCLASS()
class USettingsItemGameplayControllerSensitivityX : public USettingsItem
{
	GENERATED_BODY()
