...
#include "BTDecorator_UskIsWaitingForExecution.h"
 ...
 */
UBTDecorator_UskIsWaitingForExecution::UBTDecorator_UskIsWaitingForExecution()
{
	NodeName = "Is Waiting For Execution";
	bNotifyTick = false;
}
 ...
 */
bool UBTDecorator_UskIsWaitingForExecution::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
	...
	return EnemyCharacter->IsWaitingForExecution();
}
