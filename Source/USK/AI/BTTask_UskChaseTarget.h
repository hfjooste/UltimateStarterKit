...
#include "BTTask_UskChaseTarget.generated.h"

/**
 * @brief Behaviour tree task node used to make the enemy character chase the target actor
 */
UCLASS(Category = "Ultimate Starter Kit", meta = (DisplayName = "Chase Target"))
class USK_API UBTTask_UskChaseTarget : public UUSKBTTaskNode
{
	GENERATED_BODY()
