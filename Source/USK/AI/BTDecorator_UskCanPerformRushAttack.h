...
#include "BTDecorator_UskCanPerformRushAttack.generated.h"

/**
 * @brief Decorator used to check if the enemy can perform a rush attack
 */
UCLASS(Category = "Ultimate Starter Kit", meta = (DisplayName = "Can Perform Rush Attack"))
class USK_API UBTDecorator_UskCanPerformRushAttack : public UBTDecorator
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UBTDecorator_UskCanPerformRushAttack();
