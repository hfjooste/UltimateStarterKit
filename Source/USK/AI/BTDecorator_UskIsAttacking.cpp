...
#include "BTDecorator_UskIsAttacking.h"
 ...
 */
UBTDecorator_UskIsAttacking::UBTDecorator_UskIsAttacking()
{
 ...
 */
bool UBTDecorator_UskIsAttacking::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
