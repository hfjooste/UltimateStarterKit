...
#include "BTTask_UskSelectSummonLocation.h"
 ...
 */
UBTTask_UskSelectSummonLocation::UBTTask_UskSelectSummonLocation()
{
	NodeName = "Select Summon Location";
}
 ...
 */
EBTNodeResult::Type UBTTask_UskSelectSummonLocation::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
