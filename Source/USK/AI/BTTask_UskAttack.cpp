 ...
 */
UBTTask_UskAttack::UBTTask_UskAttack()
{
	NodeName = "Attack";
}
 ...
 */
EBTNodeResult::Type UBTTask_UskAttack::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	EnemyCharacter->StartAttacking(AttackType);
