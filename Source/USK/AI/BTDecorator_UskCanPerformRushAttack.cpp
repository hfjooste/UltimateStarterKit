...
#include "BTDecorator_UskCanPerformRushAttack.h"
 ...
 */
UBTDecorator_UskCanPerformRushAttack::UBTDecorator_UskCanPerformRushAttack()
{
	NodeName = "Can Perform Rush Attack";
	bNotifyTick = false;
}
 ...
 */
bool UBTDecorator_UskCanPerformRushAttack::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
	...
	return EnemyCharacter->CanPerformRushAttack();
}
