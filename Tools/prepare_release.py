...
os.system(f"python \"{docs}\" --input \"AI\\BTDecorator_UskIsDodgeQueued\" --output btdecorator_isdodgequeued")
os.system(f"python \"{docs}\" --input \"AI\\BTDecorator_UskIsDodging\" --output btdecorator_isdodging")
...
os.system(f"python \"{docs}\" --input \"AI\\BTTask_UskDodge\" --output bttask_dodge")
os.system(f"python \"{docs}\" --input \"AI\\BTTask_UskFlyChaseTarget\" --output bttask_flychasetarget")
os.system(f"python \"{docs}\" --input \"AI\\BTTask_UskFocusLocation\" --output bttask_focuslocation")
...
os.system(f"python \"{docs}\" --input \"AI\\BTTask_UskMoveToSummonLocation\" --output bttask_movetosummonlocation")
...
os.system(f"python \"{docs}\" --input \"AI\\BTTask_UskQueueDodge\" --output bttask_queuedodge")
