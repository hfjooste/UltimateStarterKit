...
#include "SettingsItemGraphicsViewDistance.generated.h"

/**
 * @brief An implementation for the graphics view distance settings item
 */
UCLASS()
class USettingsItemGraphicsViewDistance : public USettingsItem
{
	GENERATED_BODY()
