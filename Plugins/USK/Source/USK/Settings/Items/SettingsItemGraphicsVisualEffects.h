...
#include "SettingsItemGraphicsVisualEffects.generated.h"

/**
 * @brief An implementation for the graphics visual effects settings item
 */
UCLASS()
class USettingsItemGraphicsVisualEffects : public USettingsItem
{
	GENERATED_BODY()
