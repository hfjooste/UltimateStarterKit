...
#include "SettingsItemGraphicsAntiAliasing.generated.h"

/**
 * @brief An implementation for the graphics anti-aliasing settings item
 */
UCLASS()
class USettingsItemGraphicsAntiAliasing : public USettingsItem
{
	GENERATED_BODY()
