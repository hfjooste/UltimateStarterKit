...
#include "SettingsItemGraphicsVsync.generated.h"

/**
 * @brief An implementation for the graphics vsync settings item
 */
UCLASS()
class USettingsItemGraphicsVsync : public USettingsItem
{
	GENERATED_BODY()
