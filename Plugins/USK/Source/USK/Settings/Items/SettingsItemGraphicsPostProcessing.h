...
#include "SettingsItemGraphicsPostProcessing.generated.h"

/**
 * @brief An implementation for the graphics post processing settings item
 */
UCLASS()
class USettingsItemGraphicsPostProcessing : public USettingsItem
{
	GENERATED_BODY()
