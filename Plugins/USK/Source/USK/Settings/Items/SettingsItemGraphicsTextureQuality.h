...
#include "SettingsItemGraphicsTextureQuality.generated.h"

/**
 * @brief An implementation for the graphics texture quality settings item
 */
UCLASS()
class USettingsItemGraphicsTextureQuality : public USettingsItem
{
	GENERATED_BODY()
