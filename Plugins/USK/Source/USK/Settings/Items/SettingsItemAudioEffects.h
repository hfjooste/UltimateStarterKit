...
#include "SettingsItemAudioEffects.generated.h"

/**
 * @brief An implementation for the audio effects settings item
 */
UCLASS()
class USettingsItemAudioEffects : public USettingsItem
{
	GENERATED_BODY()
