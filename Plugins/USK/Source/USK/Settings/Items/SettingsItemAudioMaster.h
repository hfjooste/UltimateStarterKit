...
#include "SettingsItemAudioMaster.generated.h" 

/**
 * @brief An implementation for the audio master settings item
 */
UCLASS()
class USettingsItemAudioMaster : public USettingsItem
{
	GENERATED_BODY()
