...
<table>
    ...
    <tr>
        ...
        <td>FLinearColor</td>
        <td>Transparent Black (#00000000)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><strong>Value (int)</strong><br/>The current value of the menu item</td>
    </tr>
</table>
...
## Blueprint Usage
You can update the widget using Blueprints by adding one of the following nodes (requires a reference to the <code>Menu Item</code>):
<ul>
